...
const Carousel = () => {
    return ( 
        <div className="h-screen bg-cover bg-center bg-fixed" style={{ backgroundImage: "url('../../../categoriesplandeahorro.png')"}}>
            <div className='max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center'>
                ...
                >
                    ...
                    <div className="my-2">
                        ...
                        <Link href='https://wa.me/5491122502345?text=Hola!%20Necesito%20m%C3%A1s%20informaci%C3%B3n%20sobre%20un%20veh%C3%ADculo%20publicado%20en%20la%20web.'>
